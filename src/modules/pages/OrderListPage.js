...
import { GetBuyerDetailsByBuyerId, GetOrderByBuyer } from '../_redux/CommonAction'
...
const OrderListPage = ({ isLogin }) => {
    ...
    return (<>
        ...
        <div className='user_info'>
            <UserMenu buyerDetails={buyerDetails} activeTab='order' />
            <div className='right'>
                    ...
                    <div className='container'>
                        ...
                        <div className='products_list'>
                            {orderList?.length > 0 && orderByStatus(orderList, tab).length > 0 ? orderByStatus(orderList, tab).map((item, index) => (
                                ...
                                (<div className='mt10'>{isOrderListLoading ? 'Loading orders...' : 'NO ORDER FOUND'}</div>)}
                        </div>
                    </div>
                </div>
            </div>
