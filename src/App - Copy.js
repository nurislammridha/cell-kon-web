...
<div className='right'>
  <div className='title_section'>
    <div>Yamaha yZF R15 df er rtt rtt rtt frt rtg rrt</div>
    <div className='share'>
    <i class="fa fa-share-alt" aria-hidden="true"></i>
    </div>
  </div>
  <div className='brand'>Brand: YAMAHA</div>
  <div className='sold_by'>Sild By: YAMAHA Official</div>
  <div className='del_price'>&#2547;4,50990</div>
  <div className='sell_price'>&#2547;4,50990</div>
  <div className='txt_cq'>Color</div>
  <div className='colors'>
   {[1,2,3,4].map()} <a href>Black</a>
  </div>
  <div className='txt_cq'>Color</div>
</div>
            </div> */}
